// CONFIGURACIÓN DE LOS 30 TEMAS RETRO EN MEMORIA ESTABLE
const themes = {
    classic: {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // VINCULACIÓN DINÁMICA DE CAMPOS DE TEXTO
    ...
    // DINÁMICA DE SLIDERS (ESTADÍSTICAS)
    ...
    // PALETA MANUAL DE COLORES PERSONALIZADOS
    ...
    // --- ENTORNO GRÁFICO SEGURO DE CANVASES NATIVOS ---
    const canvasConfig = {
    ...
    // --- GESTIÓN DE PALETA PURA (SIDEBAR MODEL SHEET) ---
    ...
    // --- COMPILADOR DE RASTERIZACIÓN COMPATIBLE CON GITHUB PAGES ---
